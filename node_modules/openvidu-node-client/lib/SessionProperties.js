...
var SessionProperties = /** @class */ (function () {
    function SessionProperties(mediaModeProp, archiveModeProp, archiveLayoutProp, rCustomLayout) {
        this.mediaModeProp = mediaModeProp;
        this.archiveModeProp = archiveModeProp;
        this.archiveLayoutProp = archiveLayoutProp;
        this.rCustomLayout = rCustomLayout;
    }
    ...
    SessionProperties.prototype.customLayout = function () {
...
(function (SessionProperties) {
    var Builder = /** @class */ (function () {
        ...
        Builder.prototype.customLayout = function (customLayout) {
